...
const suppliers = [
  {
    ...
    izinSarana: { number: 'PBF-2024-001234', expiryDate: new Date('2028-06-30') },
    cdobCdakb: { number: 'CDOB-2024-005678', expiryDate: new Date('2027-12-31') },
    sipSik: { number: 'SIP-2024-001234', expiryDate: new Date('2028-12-31') },
    paymentTermDays: 30,
  ...
  },
  {
    ...
    izinSarana: { number: 'PBF-2024-002345', expiryDate: new Date('2028-03-15') },
    cdobCdakb: { number: 'CDOB-2024-006789', expiryDate: new Date('2027-09-30') },
    paymentTermDays: 45,
  ...
  },
  {
    ...
    izinSarana: { number: 'PBF-2024-003456', expiryDate: new Date('2027-11-20') },
    cdobCdakb: { number: 'CDOB-2024-007890', expiryDate: new Date('2027-06-15') },
    paymentTermDays: 30,
  },
  {
    name: 'PT Sanbe Farma',
    ...
    izinSarana: { number: 'IF-2024-001122', expiryDate: new Date('2029-01-01') },
    cdobCdakb: { number: 'CDOB-2024-008901', expiryDate: new Date('2028-06-30') },
    paymentTermDays: 60,
  ...
  },
  {
    ...
    cdobCdakb: { number: 'CDOB-2024-009012', expiryDate: new Date('2028-03-31') },
    paymentTermDays: 30,
  },
  {
  ...
  },
  {
    ...
    izinSarana: { number: 'DAK-2024-001122', expiryDate: new Date('2028-09-30') },
    sipSik: { number: 'SIK-2024-002233', expiryDate: new Date('2027-12-31') },
    paymentTermDays: 30,
  ...
  },
  {
    ...
    izinSarana: { number: 'PBF-2024-004567', expiryDate: new Date('2028-09-30') },
    cdobCdakb: { number: 'CDOB-2024-010123', expiryDate: new Date('2028-01-15') },
    paymentTermDays: 30,
  ...
  },
  {
    ...
    izinSarana: { number: 'PBF-2024-005678', expiryDate: new Date('2027-12-31') },
    cdobCdakb: { number: 'CDOB-2024-011234', expiryDate: new Date('2027-08-31') },
    paymentTermDays: 30,
